...
function CreatePage() {
    ...
    const handleGenerate = async () => {
        ...
        try{
            ...
            const musicPrompt = `Cretate a ${genre} song titled "${title}". Musical style: ${prompt}. High quality production with clear melody and rhythm.`;
        ...
        <div>
            ...
            <div>
                ...
                <div>
                    ...
                    placeholder="生成したい音楽の特徴や雰囲気を詳しく説明してください"
                    />
                </div>
